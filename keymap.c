 ...
 * |   `  |   !  |   @  |   #  |   $  |   %  |-------.    ,-------|   ^  |   &  |   *  |   (  |   )  |   -  |
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
 * | PGUP | PGDN |  INS | HOME |  END |  DEL |-------|    |-------| BKSP |   _  |   +  |   {  |   }  |   |  |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |LOWER | /Space  /       \Enter \  |RAISE |BackSP| RGUI |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
...
[_LOWER] = LAYOUT(
  ...
  KC_PGUP, KC_PGDN, KC_INS, KC_HOME, KC_END, KC_DEL, _______, _______, KC_BSPC, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
 ...
 * |   `  |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |-------.    ,-------| Copy | Left | Down |  Up  |Right | Paste|
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
...
[_RAISE] = LAYOUT(
  ...
  KC_F1,  KC_F2,    KC_F3,   KC_F4,   KC_F5,   KC_F6,                       KC_COPY, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_PASTE,
 ...
 */
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_COPY, XXXXXXX,                   XXXXXXX, KC_PASTE, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = { 
    ...
    [3] = { ENCODER_CCW_CW(MS_DOWN, MS_UP),  ENCODER_CCW_CW(MS_LEFT, MS_RGHT) },
};
#endif

//bool encoder_update_user(uint8_t index, bool clockwise) {
//    if (layer_state_is(_ADJUST)){/*When on adjust layer, enter etch-a-sketch mode*/
//        if (index == 0) { /*Left encoder, mouse up & down*/
//            if (clockwise) { 
//                tap_code(MS_UP);
//            } else {
//                tap_code(MS_DOWN); 
//            }
//        } else if (index == 1) { /*Right encoder, mouse left & right*/
//            if (clockwise) {
//                tap_code(MS_LEFT);
//            } else {
//                tap_code(MS_RGHT);
...
//        return false;
//    } else {
//        if (index == 0) { /*Left encoder, vol up & down*/
//            if (clockwise) {
//                tap_code_delay(KC_VOLU, 10);
//            } else {
//                tap_code_delay(KC_VOLD, 10);
//            }
//        } else if (index == 1) { /*Right encoder, scroll up & down */
//            if (clockwise) {
//                tap_code(KC_DOWN);
//            } else {
//                tap_code(KC_UP);
